...
\LARGE
PROBLEM:\\
``There is no product (like MODIS Chl-a product) for medium/small water bodies (hundreds or tens of meters) over coastal or inland water.''
\end{frame}
% --- slide ------------------------------------------------
...
\hline
2 month   & 	\parbox[t]{7cm}{Optimization Routine for 4-D LUT:\\
				} \\
\hline \hline
