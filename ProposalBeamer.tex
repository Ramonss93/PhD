...
\item {\bf Why?}\\
``How is the Earth system changing, and what are the consequences of life on Earth?'' (NASA Strategic Plan)\\

\item Changes can be observed in the patterns and quality of inland and coastal waters.\\
\end{itemize}
\end{frame}
% --- slide ------------------------------------------------
\begin{frame}{\LARGE Motivation} 
\Large
\begin{itemize}\itemsep.5cm
\item Conditions of inland and coastal water drive: weather conditions, influence marine diversity, and impact agriculture, among other.\\

\item This influence human conditions.\\

\item By identifying, quantifying, and monitoring these changes, we could understand, describe, and predict the consequences of those changes, and more importantly stay ahead of them.\\
\end{itemize}
\end{frame}
% --- slide ------------------------------------------------
