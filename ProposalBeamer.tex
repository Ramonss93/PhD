...
\Large
\begin{itemize}\itemsep.4cm
	\item Atmospheric Correction: Compare with results in SeaDAS (future release)\\
		...
		% \medskip
    	\end{minipage}
	\item Retrieval: Compare with Ocean Optics products. Example: MODIS chl-{\it a} product\\
		\begin{minipage}[t]{\linewidth}
          	\centering
          	\adjustbox{valign=t}{%
				\includegraphics[height=3cm]{/Users/javier/Desktop/Javier/PHD_RIT/ConferencesAndApplications/2014_ASPRS_SOY/Images/107325main_chloro_concentrate.jpg}
...
% --- slide ------------------------------------------------
\begin{frame}{\LARGE Retrieval}{\vspace{.1cm} \Large Using RMSE}
% \vspace{-.3cm}
\centering
\begin{figure}[htb]
\centering
...
\end{columns}
\vspace{1cm}
\centerline{For one day and one study area}
\end{frame}
% --- slide ------------------------------------------------
...
\begin{itemize}\itemsep.4cm
	...
	\item LUT in Hydrolight: Highly dependent in phase function
...
\Large
\begin{itemize}\itemsep.4cm
	\item Fix LUT creation in Hydrolight to have a better agreement between the model and field data

	\item Retrieval applied to more days in the area of study

	\item Atmospheric Correction: Use \cite{Gordon:1994} methods with SWIR bands, and Blue Band and Band Ratio \cite{GeraceThesis}

\end{itemize}

\end{frame}
% --- slide ------------------------------------------------
\begin{frame}{\LARGE Future Work (con't)}
\Large
\begin{itemize}\itemsep.4cm

	\item Applied Optimization routine for 4-D LUT

	\item Comparison and Validation

	\item Try in different area of study

	\item Journal articles for atmospheric correction and retrieval
...
1 month   & 	\parbox[t]{7cm}{Atmospheric Correction:\\
				- Apply \cite{Gordon:1994} method\\
				- Apply \cite{GeraceThesis} method} \\
\hline
1 month   & 	\parbox[t]{7cm}{Optimization Routine for 4-D LUT:\\
				} \\
\hline \hline
...
\end{frame}
% --- slide ------------------------------------------------
\begin{frame}{\LARGE Timeline (con't)}
\small
\begin{tabular*}{\textwidth}{l l}
\hline
        		\bfseries{Estimated Time}  	& \bfseries{Description} \\ 
...
\hline
1 month   & 	\parbox[t]{7cm}{Apply retrieval in different are of study:\\
				} \\
\hline
1 month   & 	\parbox[t]{7cm}{Write Thesis and Journal:\\
