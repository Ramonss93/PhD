...
% --- slide ------------------------------------------------
\begin{frame}{\LARGE Background and Theory}{\Large Subsection 1}
...
% --- slide ------------------------------------------------
\begin{frame}{\LARGE Methodology and Approach}{\Large Over-Water Atmospheric Correction}

\end{frame}
% ---------------- Subsection ------------------------------
\subsection{In-Water Constituent Retrieval Process}
% --- slide ------------------------------------------------
\begin{frame}{\LARGE Methodology and Approach}{\Large In-Water Constituent Retrieval Process}

\end{frame}
% ---------------- Subsection ------------------------------
\subsection{Ground Truth Data Collection}
% --- slide ------------------------------------------------
\begin{frame}{\LARGE Methodology and Approach}{\Large Ground Truth Data Collection}

\end{frame}
% ---------------- Subsection ------------------------------
\subsection{Validation}
% --- slide ------------------------------------------------
\begin{frame}{\LARGE Methodology and Approach}{\Large Validation}
...
% --- slide ------------------------------------------------
\begin{frame}{\LARGE Preliminary Results}{\Large Data Collection}

\end{frame}
% ---------------- Subsection ------------------------------
\subsection{Laboratory Measurements}
% --- slide ------------------------------------------------
\begin{frame}{\LARGE Preliminary Results}{\Large Laboratory Measurements}

\end{frame}
% ---------------- Subsection ------------------------------
\subsection{Atmospheric Correction}
% --- slide ------------------------------------------------
\begin{frame}{\LARGE Preliminary Results}{\Large Atmospheric Correction}

\end{frame}
% ---------------- Subsection ------------------------------
\subsection{Retrieval}
% --- slide ------------------------------------------------
\begin{frame}{\LARGE Preliminary Results}{\Large Retrieval}
