...
The connection between the IOPs and the radiances is made through the radiative transfer equation (RTE). It expresses conservation of energy for a collimated beam of radiance traveling through an absorbing, scattering and emitting medium. The RTE is expresses as
\begin{align}
...
\end{align}
where the angle between the incident direction $(\omega',\phi')$ and the scattered direction $(\omega,\phi)$ is the scattering angle $\psi$ in the VSF. Below there is an explanation for each term in the RTE.
