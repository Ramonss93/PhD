...
The water-leaving reflectance could be contaminated by glint effects product of sun light reflected off the air-water surface. There will be a bigger chance of have more glint-contaminated pixels when high spatial details are imaged by the sensor. For instance, Landsat 8's $30m$ pixels will captured more glint than MODIS' $1km$ pixels. It is important to note that the image-derived surface reflectance of the contaminated areas with the sun glint will closely resemble the solar spectrum (or ``white light''). This fact produces the NIR and SWIR pixels to appear brighter than common water pixels. Different algorithm have been developed to correct images from sun glint (glint removal). Most of these algorithm are based upon the concept that water-leaving radiance is zero beyond the NIR, and therefore any contribution is due to sun glint.
% ----------------------------------------------------
