...
\begin{figure}[htb]
  \centering
  \includegraphics[height=8cm]{/Users/javier/Desktop/Javier/PHD_RIT/Latex/Proposal/Images/PathsVisio.eps}
...
The amount of radiation scattered and absorbed by a small volume of aerosol can be different. Therefore, the optical properties of a small volume of aerosol can be described by three parameters: extinction coefficient $K_e$, single-scattering albedo $\omega_o$ and scattering phase function $P(\theta)$ \cite{Asrar1989}.

The extinction coefficient $K_e$ describes the fraction of radiation taken from the direct beam by the aerosol (named beam attenuation in the aquatic medium). The single-scattering albedo $\omega_o$ is the fraction of scattering from the total extinction ($\omega_o$= scattering coefficient/extinction coefficient). The scattering phase function $P(\theta)$ describes the angular distribution of scattered radiation, where $\theta$ is the scattering angle.
